...
from aplicativo.views.assunto02.assunto02_capitulo01_View import (
     ...
     assunto02_capitulo01_Tabela1ListView,
...
urlpatterns = [
    path('assunto02_index/', assunto02_index_View, name='assunto02_index'),
    ...
    path('assunto02_Capitulo01_Update_View/<int:pk>/', 
     ...
     path('assunto02_capitulo01_Tabela1ListView/', assunto02_capitulo01_Tabela1ListView.as_view(), name='assunto02_capitulo01_Tabela1ListView')
]
