...
class Tabela1Form(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'campo2': forms.TextInput(attrs={
                'class': 'form-control',
                'placeholder': 'Digite o Campo 2, texto curto'
            }),
            'campo3': forms.Select(choices=Tabela1.CONFIRMA, attrs={
                'class': 'form-control',
            }),
            'campo4': forms.CheckboxInput(attrs={
                'class': 'form-check-input'
            }),
            'campo5': forms.Textarea(attrs={
                'class': 'form-control',
                'placeholder': 'Campo 5, texto longo'
            }),
        }
